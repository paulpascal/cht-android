...
public class P2pForegroundService extends Service {
	...
	public void onCreate() {
		...
		log(this, "P2P foreground service created");
	}

	@Override
	public int onStartCommand(Intent intent, int flags, int startId) {
		if (intent == null) {
			warn(this, "Received null intent, stopping");
			stopSelf();
		...
		if (ACTION_START.equals(action)) {
			...
			warn(this, "Unknown action: " + action);
		}
	...
	public void onDestroy() {
		log(this, "P2P foreground service destroyed");
	...
	private void handleStart() {
		log(this, "Starting foreground P2P sync service");
	...
	/**
		...
		*
		* stopForeground(int) only exists from SDK 24, so the deprecated boolean overload is the
		* only option on SDK 21 to 23. The deprecation warning it raises is expected.
		*/
	private void handleStop() {
		log(this, "Stopping foreground P2P sync service");
